...
/**************************************************************************
** ¹¦ÄÜ	@brief : socket·¢ËÍ,ÊÊÓÃÓÚLINUX TCP/UART
** ÊäÈë	@param :
** Êä³ö	@retval:
***************************************************************************/
    ...
    *type = SOCKET_TYPE_TCP_CLI;
    ...
    while (node)
    {
        ...
        if (sockFd >= 0)
        {
			...
			fcntl(sockFd, F_SETFL, flag | O_NONBLOCK);    //ÉèÖÃ³É·Ç×èÈûÄ£Ê½
...
/**************************************************************************
** ¹¦ÄÜ	@brief : TCP SSL client connect
** ÊäÈë	@param :
** Êä³ö	@retval:
***************************************************************************/
...
/**************************************************************************
** ¹¦ÄÜ	@brief : UDP SSL client connect
** ÊäÈë	@param :
** Êä³ö	@retval:
***************************************************************************/
